          ...
          <div className="max-w-4xl mx-auto">
            <AnimatedSection>
              <div className="text-center">
                <span className="inline-block bg-white/20 text-white px-4 py-1.5 rounded-full text-sm font-medium mb-6">Transit Technology That Delivers Results</span>
                ...
                <div className="flex flex-wrap justify-center gap-5 mb-8">
                  <a href="/demo-request" className="cta-button bg-white text-enterprise-primary hover:bg-gray-100">
                    Request a Demo <ArrowRight className="w-5 h-5" />
                  </a>
                  <a href="/roi-calculator" className="cta-button bg-enterprise-accent hover:bg-enterprise-accent-dark">
                    Calculate Your ROI <Calculator className="w-5 h-5" />
                  </a>
                </div>
                <p className="text-white text-base">
                  <strong>Trusted by 30+ transit agencies</strong> including Denver RTD, San Joaquin COG, and NEORide
                </p>
              </div>
            </AnimatedSection>
          </div>
        ...
        <div className="container mx-auto px-6">
          <AnimatedSection>
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                See how transit agencies have transformed their operations with our solutions.
              </p>
            </div>
          </AnimatedSection>
          ...
          <div className="grid md:grid-cols-2 gap-6 lg:gap-8 mb-12">
            <AnimatedSection delay={100}>
              <CaseStudyCard caseStudyId="denver-rtd" />
            </AnimatedSection>
            
            <AnimatedSection delay={200}>
              <CaseStudyCard caseStudyId="san-joaquin-vamos" />
            </AnimatedSection>
          </div>
          ...
          <AnimatedSection delay={300}>
            <div className="text-center">
              <Link 
                to="/success-stories" 
                className="inline-flex items-center bg-enterprise-primary px-6 py-3 text-white font-medium rounded-lg hover:bg-enterprise-primary/90 transition-colors"
              >
