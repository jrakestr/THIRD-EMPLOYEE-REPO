  ...
  const products = [
    {
      ...
      implementations: [
        "Denver RTD: Operating 23 service zones with 45 vehicles",
        "Pace Suburban Bus: Managing 10 OnDemand service zones"
      ],
    ...
    },
    {
      ...
      implementations: [
        "San Joaquin COG: Connecting 7+ transit providers in Northern California",
        "Turlock Transit: Integrated fixed-route and on-demand services"
      ],
