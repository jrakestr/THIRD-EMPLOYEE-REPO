...
import { useSolution } from '../controllers/SolutionController';
...
const SolutionDetail = () => {
  ...
  // Use the controller to fetch solution data
  const { solution, loading, error } = useSolution(solutionId);
    ...
    return (
      <div className="pt-24 min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-enterprise-primary mb-4 font-heading">Solution Not Found</h1>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="md:w-1/2">
                  <h1 className="text-4xl md:text-5xl font-bold mb-4 font-heading">{solution.title}</h1>
            ...
            <AnimatedSection delay={400}>
              <div className="max-w-3xl mx-auto">
                <div className="bg-gray-50 rounded-xl p-8 md:p-12">
                  <h3 className="text-2xl font-bold mb-6 text-enterprise-primary font-heading">Key Benefits</h3>
          ...
          <div className="container mx-auto px-6">
            <AnimatedSection>
              <div className="max-w-3xl mx-auto text-center mb-16">
                ...
                <p className="text-gray-600">
                  Discover how {solution.title} can transform your transit operations with these powerful features.
                </p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={200}>
              <div className="grid lg:grid-cols-2 gap-12 mb-20">
                <div>
                  <img 
                    src={solution.screenshots[0].image}
                ...
                <div>
                  <img 
                    src={solution.screenshots[1].image}
                    alt="Feature Highlight"
                    className="rounded-xl shadow-xl mb-8"
                  />
              ...
              <div className="max-w-3xl mx-auto">
                <div className="bg-gradient-to-r from-enterprise-primary to-enterprise-accent rounded-xl p-8 md:p-12 text-white">
                  ...
                  <p className="text-white/90 mb-8">
                    Schedule a personalized demo to see how {solution.title} can transform your transit operations.
                  </p>
                  <div className="flex flex-wrap gap-4">
                    <BrandedButton variant="primary" className="bg-white text-enterprise-primary">
                      Schedule a Demo
          ...
          <div className="container mx-auto px-6">
            <AnimatedSection>
              <div className="max-w-3xl mx-auto text-center mb-16">
                ...
                <p className="text-gray-600">
                  Get a closer look at the {solution.title} interface and features.
                </p>
              </div>
            </AnimatedSection>
          ...
          <div className="container mx-auto px-6">
            <AnimatedSection>
              <div className="max-w-3xl mx-auto text-center mb-16">
                ...
                <p className="text-gray-600">
                  Detailed technical information about the {solution.title} platform.
                </p>
              </div>
            </AnimatedSection>
              ...
              <div className="max-w-4xl mx-auto">
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="bg-white p-8 rounded-xl shadow-md border border-gray-100">
                    ...
                    <ul className="space-y-3">
                      {solution.technicalSpecs.deployment.map((item, index) => (
                        <li key={index} className="flex items-start gap-3">
                          <div className="mt-1">
                            <Check className="w-5 h-5 text-enterprise-accent" />
                          </div>
                  ...
                  <div className="bg-white p-8 rounded-xl shadow-md border border-gray-100">
                    ...
                    <ul className="space-y-3">
                      {solution.technicalSpecs.integration.map((item, index) => (
                        <li key={index} className="flex items-start gap-3">
                          <div className="mt-1">
                            <Check className="w-5 h-5 text-enterprise-accent" />
                          </div>
                  ...
                  <div className="bg-white p-8 rounded-xl shadow-md border border-gray-100">
                    ...
                    <ul className="space-y-3">
                      {solution.technicalSpecs.security.map((item, index) => (
                        <li key={index} className="flex items-start gap-3">
                          <div className="mt-1">
                            <Check className="w-5 h-5 text-enterprise-accent" />
                          </div>
                  ...
                  <div className="bg-white p-8 rounded-xl shadow-md border border-gray-100">
                    ...
                    <ul className="space-y-3">
                      {solution.technicalSpecs.requirements.map((item, index) => (
                        <li key={index} className="flex items-start gap-3">
                          <div className="mt-1">
                            <Check className="w-5 h-5 text-enterprise-accent" />
                          </div>
              ...
              <div className="max-w-3xl mx-auto mt-16">
                <div className="bg-gray-50 rounded-xl p-8 md:p-12">
                  ...
                  <p className="text-gray-600 mb-8">
                    Access detailed technical documentation for the {solution.title} platform.
                  </p>
          ...
          <div className="container mx-auto px-6">
            <AnimatedSection>
              <div className="max-w-3xl mx-auto text-center mb-16">
                ...
                <p className="text-gray-600">
                  See how transit agencies are transforming their operations with {solution.title}.
                </p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={400}>
              <div className="max-w-3xl mx-auto mt-16">
                <div className="bg-gradient-to-r from-enterprise-primary to-enterprise-accent rounded-xl p-8 md:p-12 text-white">
                  ...
                  <p className="text-white/90 mb-8">
                    Contact our team to discuss how {solution.title} can transform your transit operations.
                  </p>
                  <div className="flex flex-wrap gap-4">
                    <BrandedButton variant="primary" className="bg-white text-enterprise-primary">
                      Contact Sales
          ...
          <div className="container mx-auto px-6">
            <AnimatedSection>
              <div className="max-w-3xl mx-auto text-center mb-16">
                ...
                <p className="text-gray-600">
                  Find answers to common questions about {solution.title}.
                </p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={400}>
              <div className="mt-16 bg-gradient-to-r from-enterprise-primary to-enterprise-accent rounded-xl p-8 md:p-12 text-white">
                <div className="max-w-3xl mx-auto text-center">
                  ...
                  <p className="text-white/90 mb-8">
                    Our team is ready to help you understand how {solution.title} can transform your transit operations.
                  </p>
